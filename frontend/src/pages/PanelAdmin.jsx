                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-2xl font-bold text-gray-900">{estadisticas.totalAgentes}</p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                    ...
                    >
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-gray-500 text-sm">Agregar nueva propiedad al sistema</p>
                            </div>
                        </div>
                    </Link>
                    ...
                    >
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                <h3 className="text-lg font-bold text-gray-900 group-hover:text-slate-700 transition-colors">Gestionar Propiedades</h3>
                                <p className="text-gray-500 text-sm">Ver y editar todas las propiedades</p>
                            </div>
                        </div>
                    </Link>
                    ...
                    >
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-gray-500 text-sm">Agregar nuevo cliente al sistema</p>
                            </div>
                        </div>
                    </Link>
                    ...
                    >
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                <h3 className="text-lg font-bold text-gray-900 group-hover:text-slate-700 transition-colors">Gestionar Clientes</h3>
                                <p className="text-gray-500 text-sm">Ver y administrar los clientes</p>
                            </div>
                        </div>
                    </Link>
                    ...
                    >
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                <h3 className="text-lg font-bold text-gray-900 group-hover:text-slate-700 transition-colors">Negociaciones</h3>
                                <p className="text-gray-500 text-sm">Gestionar negociaciones activas</p>
                            </div>
                        </div>
                    </Link>
                    ...
                    >
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                <h3 className="text-lg font-bold text-gray-900 group-hover:text-orange-600 transition-colors">Registrar Agente</h3>
                                <p className="text-gray-500 text-sm">Crear nueva cuenta de agente</p>
                            </div>
                        </div>
                    </Link>
                    ...
                    >
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                <h3 className="text-lg font-bold text-gray-900 group-hover:text-slate-700 transition-colors">Gestionar Agentes</h3>
                                <p className="text-gray-500 text-sm">Ver y administrar agentes</p>
                            </div>
                        </div>
                    </Link>
                </div>
