...
export default function FiltroPropiedadesAdmin({ filtros, setFiltros, onFiltrar, busqueda, setBusqueda }) {
    ...
    const cargarOpcionesFiltros = async () => {
        try {
            // Obtener todas las propiedades para extraer opciones ├║nicas
    ...
    const handleFiltroChange = (campo, valor) => {
        ...
        // No llamamos onFiltrar aqu├¡ porque se maneja en el useEffect de Propiedades.jsx
    };
    ...
    const limpiarFiltros = () => {
        ...
        setBusqueda(''); // Limpiar tambi├®n la b├║squeda
        // No llamamos onFiltrar aqu├¡ porque se maneja en el useEffect de Propiedades.jsx
    };
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 mb-8">
            ...
            <div className="mb-6">
                <div className="relative">
                    <input
                        type="text"
                        placeholder="Buscar por t├¡tulo de propiedad..."
                        value={busqueda}
